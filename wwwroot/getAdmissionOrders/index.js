...
module.exports = function (context, myTimer) {
    ...
    var statusFilename = process.env["StatusFilename-Admissions"];
    var ordersFilename = process.env["OrdersFilename-Admissions"];
    ...
    var shopifyAlias = process.env["ShopifyAlias-Admissions"];
    var shopifyUsername = process.env["ShopifyUsername-Admissions"];
    var shopifyPassword = process.env["ShopifyPassword-Admissions"];
